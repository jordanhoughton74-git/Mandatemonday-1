        ...
        <div className="wrapper">
            ...
            <Row className={styles.footer}>
                <Col md={4} sm={12} className={styles.left}>
                    <a href="mailto:mondaymandate@gmail.com"><p className="grey-text">Email: mondaymandate@gmail.com</p></a>
                ...
                <Col md={4} sm={12} className={styles.right}>
                    <p className="grey-text-mobile">Email: mandatemonday@gmail.com</p>
